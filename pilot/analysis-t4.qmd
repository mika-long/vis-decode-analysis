...
ggsave("plots/task4-pp-check.pdf", p1, height = 5, width = 10, unit = "cm")

pp_check(model.weibull, ndraws = 100, type = "pit_ecdf") + 
  theme(text = element_text(size = 10)) -> p2

ggsave("plots/task4-pit-ecdf.pdf", p2, height = 5, width = 10, unit = "cm")
```
...
ggsave("plots/task4.pdf", plot = p, height = 5, width = 5, units = "cm")
