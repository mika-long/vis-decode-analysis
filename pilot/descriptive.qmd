...
Read in the demographic from prolific: 
...
```{r}
task3_df %>% group_by(participantId) %>% 
  summarise(correlation.y = cor(data.select.y, data.ans.y, method = "pearson"))

# standard deviation is zero lol 
```
