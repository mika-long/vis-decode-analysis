...
# for a participant to arrive at dist_to_screen to be less than 200 
# it means they did not press the space bar as instructed. 
# we do not include such participants in our analysis. 
...
This participant is selecting -5 or 5 all the time. Clearly demonstrated low effort. 
...
```{r}
exclude_participants %>% as.tibble() %>% 
  count(value)
