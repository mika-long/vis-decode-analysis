...
```{r}
task5_df %>% filter(! participantId %in% c("6679e88eb948e8a4b08a39fb", "67eb99ebe23a2e1ce36ce110")) %>% 
...
```{r}
task3_df %>% filter(! participantId %in% c("6679e88eb948e8a4b08a39fb", "67eb99ebe23a2e1ce36ce110")) %>% 
  ggplot(aes(x = va.ans.x, y = va.select.y - va.ans.y)) + 
  geom_point(alpha = 0.5)
```
