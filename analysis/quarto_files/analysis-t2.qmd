...
```{r}
loo(model.y.exponential, model.y.lognormal, model.y.weibull, 
...
```{r}
#| layout-ncol: 2
pp_check(model.x.normal, ndraws= 100) -> task2.x.gaussian

pp_check(model.x.normal, ndraws= 100, type = "pit_ecdf") -> task2.x.gaussian.pit
...
ggsave(here("figs", "task2.x.gaussian.pdf"), task2.x.gaussian, 
       height = 6, width = 8, unit = "cm", dpi = 300)
...
#| layout-ncol: 2
#| code-fold: true
pp_check(model.x.laplace, ndraws = 100) -> task2.laplace

pp_check(model.x.laplace, ndraws = 100, type = "pit_ecdf") -> task2.laplace.pit
...
#| eval: false 
#| echo: false 
ggsave(here("figs", "task2.y.laplace.pdf"), task2.laplace, 
       height = 6, width = 8, units = "cm", dpi = 300)
ggsave(here("figs", "task2.y.laplace-pit-ecdf.pdf"), task2.laplace.pit, 
       height = 6, width = 8, units = "cm", dpi = 300)
```
