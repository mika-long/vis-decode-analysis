...
source(paste0(here(), "/R/helpers.R"))
```
...
# library(nanoparquet)
# task1_df
# write_parquet(task1_df, paste0(here(), "/data/processed/task1.parquet"))
task1_df %>% as.data.frame(.) %>% write.csv(paste0(here(), "/data/processed/task1.csv"))
```
