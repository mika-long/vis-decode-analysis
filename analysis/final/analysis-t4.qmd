---
title: "Analysis --- Task 4 --- find highest slope"
---
...
ggsave("../../figs/task4-pp-check.pdf", p1, height = 5, width = 10, unit = "cm")

ggsave("../../figs/task4-pit-ecdf.pdf", p2, height = 5, width = 10, unit = "cm")
```
...
task4_df %>% modelr::data_grid(error = 0,
  ...
  stat_slab(aes(x = .prediction, group = .draw),
               color = "lightblue", alpha = 0.5, fill = NA, n = 3000, linewidth = 0.5) +
...
ggsave("../../figs/task4.pdf", plot = p, height = 5, width = 5, units = "cm")
```
...
ggsave("../../figs/task4.pdf", plot = p, height = 5, width = 5, unit = "cm", dpi = 300)
```
...
The weibull model performs the best. This can also be seen from the posterior predictive checks: 
