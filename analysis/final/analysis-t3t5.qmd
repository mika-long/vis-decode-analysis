...
Turns out these participants were aligning things wrongly on the slider (i.e, they did not match the blue dot to the red dot but matched the thing on the slider to the red dot, hence the shift in their answers. We exclude these participants from our analysis.)
...
ggsave("../../figs/task5-x-pp-check.pdf", p1, width = 10, height = 5, unit = "cm")
```
...
ggsave("../../figs/task5-x-pit-ecdf.pdf", p2, width = 10, height = 5, unit = "cm", dpi = 300)
```
...
# save 
ggsave("../../figs/task5-project-x.pdf", p1, height = 5, width = 10, units = "cm", dpi = 300)
```
...
ggsave("plots/task5-y-pp-check.pdf", p1, height = 5, width = 10, unit = "cm")

pp_check(m.5.y.va, ndraws = 100, type = "pit_ecdf") + 
  theme(text = element_text(size = 10)) -> p2 

ggsave("plots/task5-y-pit-ecdf.pdf", p2, height = 5, width = 10, unit = "cm")
```
...
```{r}
p1 + p2 -> combined
ggsave("plots/task5-combined.pdf", combined, height = 5, width = 10, units = "cm")
```
...
ggsave("plots/task3-pp-check.pdf", p1, height = 5, width = 10, unit = "cm")
```
...
ggsave("plots/task3-pit-ecdf.pdf", p2, height = 5, width = 10, unit = "cm", dpi = 300)
```
